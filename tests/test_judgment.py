...
class TestJudgment:
    ...
    def setup_judgment(self):
        ...
        try:
            self.judgment_utils = JudgmentUtils(self.driver)
            yield
    ...
    # def test_judgment_comparison(self):
    #     """
    #     测试判决书对比功能，包括：
    #     1. 选择新旧版本进行对比
    #     2. 测试窗口切换功能
    ...
    def test_document_preview_operations(self):
        """
        测试卷宗预览相关功能，包括：
        1. 文档树操作
        2. 页面导航
    ...
    # def test_judgment_import_export(self):
    #     """
    #     测试判决书导入导出功能，包括：
    #     1. 选择指定判决书
    #     2. 导出判决书
